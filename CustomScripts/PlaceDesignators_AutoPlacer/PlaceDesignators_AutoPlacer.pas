{..............................................................................}
{ PlaceDesignators_AutoPlacer.pas                                               }
{ Placement logic copied from SilkscreenAutoPlacer/AutoPlaceSilkscreen.pas.     }
{ Variant 2. Entry: StartPlaceDesignatorsAuto. Do not mix with PlaceDesignators.}
{..............................................................................}
...
procedure StartPlaceDesignatorsAuto;
begin
  RunGUI;
end;

procedure _StartPlaceDesignatorsAuto;
begin
  StartPlaceDesignatorsAuto;
end;
...
begin
  ...
  try
    Board.DisplayUnit := eMetric;
  except
  end;
  try
    Board.SnapGridUnit := eMetric;
  except
  end;
  try
    Board.SnapGridSize := MMsToCoord(0.1);
  except
    try
      Board.SetState_SnapGridSize(MMsToCoord(0.1));
    except
    end;
  end;
